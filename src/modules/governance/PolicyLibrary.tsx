...
export function PolicyLibrary({ policies }: { policies: Policy[] }) {
  return (
    <div className="col-span-12 lg:col-span-6 bg-surface-container-lowest rounded-xl border border-outline-variant p-lg shadow-sm">
      ...
      <div className="flex flex-col gap-sm">
        {policies.map((policy, i) => (
          <div key={i} className="p-md bg-surface-container-low rounded-lg border border-transparent hover:border-primary/20 transition-all flex items-center gap-md">
