...
export function TopNavBar() {
  return (
    <header className="fixed top-0 right-0 w-[calc(100%-16rem)] z-40 bg-surface/80 backdrop-blur-md flex justify-between items-center px-lg py-md h-16 border-b border-outline-variant">
